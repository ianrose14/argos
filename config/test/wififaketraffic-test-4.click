Script(print "This tests that data send-rates (at high rates) really are correct");

from_pcap::WifiFakeTraffic(LOC_X 0, LOC_Y 0,
                           GRID_WIDTH 0, GRID_LEN 0,
                           SETUP_SEED 11, TRAFFIC_SEED 10,
                           NUM_APS 10, CLIENTS_PER_AP 3,
                           AP_DATA_RATE 50,
...
Script(print "Packets per sec should be about 10*10 + 50*10 = 600");
